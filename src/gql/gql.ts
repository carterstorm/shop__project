...
export function graphql(
	source: "query CategoriesGetItemsBySlug($slug: String) {\n  category(slug: $slug) {\n    id\n    name\n    description\n    slug\n    products {\n      id\n      name\n      price\n      description\n      images {\n        url\n      }\n      categories {\n        name\n        description\n      }\n    }\n  }\n}",
 ...
 */
export function graphql(
	source: "query CollectionGetItemBySlug($slug: String) {\n  collection(slug: $slug) {\n    id\n    description\n    name\n    products {\n      id\n      name\n      description\n      price\n      rating\n      images {\n        url\n      }\n      categories {\n        name\n        description\n      }\n    }\n  }\n}",
 ...
 */
export function graphql(
	source: "query CollectionsGetList($take: Int) {\n  collections(take: $take) {\n    data {\n      id\n      name\n      slug\n    }\n  }\n}",
): typeof import("./graphql").CollectionsGetListDocument;
/**
 * The graphql function is used to parse GraphQL queries into a document that can be used by GraphQL clients.
 */
export function graphql(
	source: "query ProductGetItemById($id: ID!) {\n  product(id: $id) {\n    id\n    name\n    description\n    price\n    rating\n    images {\n      url\n    }\n    categories {\n      name\n      description\n    }\n  }\n}",
 ...
 */
export function graphql(
	source: "query ProductsGetListByFilteredCategory($take: Int!) {\n  products(take: $take) {\n    data {\n      id\n      name\n      price\n      description\n      rating\n      images {\n        url\n      }\n      categories {\n        name\n        description\n      }\n    }\n  }\n}",
): typeof import("./graphql").ProductsGetListByFilteredCategoryDocument;
/**
 * The graphql function is used to parse GraphQL queries into a document that can be used by GraphQL clients.
 */
export function graphql(
	source: "query ProductsGetListLength {\n  products {\n    meta {\n      total\n    }\n  }\n}",
